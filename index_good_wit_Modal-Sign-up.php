...
{	
   ...
   $input = $_POST['QrcText'];
   if ( empty($_POST['QrcText']) ) 
   {
		$error = '<li>QR code text is required</li>';
...
{	
   ...
   if ( empty($_POST['QrcInput']) ) 
   {
		$error = '<li>QR code file is required</li>';
...
{	
   ...
   $input = $_POST['QrcUrl'];
   if ( !empty($_POST['QrcUrl']) AND filter_var($input, FILTER_VALIDATE_URL) ) 
   {
	    ...
	    exit();
			...
			$error = '<li>QR code url field is empty or value entered is invalid </li>';
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>DiDVerSol | Welcome Email</title>
  ...
  <body>
    <center class="wrapper">
      <table class="logo" width="100%">
        <tr>
          <td style="text-align: center">
            <a href="https://didoversol.ng"
              ><img
                src="https://didoversol.ng/dist/img/certverifyLogoM.png"
                width="130"
                style="width: 100%"
                alt="Logo"
            /></a>
      ...
      <table class="main" width="100%">
        ...
        <tr>
          <td style="text-align: center">
            <img src="https://didoversol.ng/dist/img/waving-hand.png" alt="Waving Hand" />
          </td>
        </tr>
        <tr>
          <td
          ...
          >
            <p class="content">
              Thank you for signing up for DiDVerSol Services. <br>Please spare a second to confirm your email.
            </p>
          </td>
        </tr>
		...
		<!--	<a target="__blank" href="https://didoversol.ng/?confirm-email" class="button">Click Here! to CONFIRM</a> -->
		<br>
      ...
      <table class="footer">
        <tr>
          <td style="text-align: center; color: #858585">
            <p> <strong > &copy;'. date("Y"). '<a href="https://didoversol.ng" class="link" > DIDVerSol </a>.  </strong>All rights reserved. |<br> Block B, Electrical Engineering Dept. Unizik Awka Anambra State.</p>
            <a data-target="#modal-terms" href="https://didoversol.ng/?terms" class="link">Terms of Service</a>
            <a data-target="#modal-privacy" href="https://didoversol.ng/?privacy" class="link" style="padding-left: 15px">Privacy Policy</a>
			<br>
			 <p>Powered by <a href="https://auenetengtech.com.ng" class="link"><strong>AUENET</strong></a></p>
			 
			 <span class="link"> Follow us @ </span>
            <a href="https://www.facebook.com/profile.php?id=100088595886732">
              <img
                src="https://didoversol.ng/dist/img/circle-facebook.png"
                alt="Logo"
                width="20"
                title="facebook"
            /></a>
            <a href="https://twitter.com/didversol">
              <img
                src="https://didoversol.ng/dist/img/circle-twitter.png"
                alt="Logo"
                width="20"
                title="twitter"
            /></a>
            <a href="https://youtube.com/didversol">
              <img
                src="https://didoversol.ng/dist/img/circle-youtube.png"
                alt="Logo"
                width="20"
                title="youtube"
            /></a>
            <a href="https://linkedin.com/mwlite/in/did-versol-a9539525a">
              <img
                src="https://didoversol.ng/dist/img/circle-linkedin.png"
                alt="Logo"
                width="20"
                title="linkedin"
            /></a>
            <a href="https://instagram.com/didversol">
              <img
                src="https://didoversol.ng/dist/img/circle-instagram.png"
                alt="Logo"
                width="20"
                title="Instangram"
            /></a>
							...
							$_SESSION['msgr'] = "User Details added successfully. An email had been sent to the email address provided with activation code.";
